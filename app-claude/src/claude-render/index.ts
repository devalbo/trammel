export { Sprite } from './primitives/Sprite';
export type { SpriteProps } from './primitives/Sprite';
...
export type { LineProps, Point2D } from './primitives/Line';

export { SpriteText } from './primitives/SpriteText';
export type { SpriteTextProps } from './primitives/SpriteText';

export { Path } from './primitives/Path';
export type { PathProps } from './primitives/Path';

export { Point } from './primitives/Point';
export type { PointProps } from './primitives/Point';
...
export { SolverProvider, useSolver, useSolverDiagnostics, useSolverShapes, useRenderPhase, AnchorRegistry, parseRef } from './primitives/SolverContext';
export type { SolverProviderProps, SolverDiagnostic, DiagnosticLevel, ViewBox, RealizedShape } from './primitives/SolverContext';

export { parseExpr, evaluate, parseAndEvaluate, collectAnchors, tokenize, ParseError } from './primitives/ExprParser';
export type { Expr, RefLookup, Token, TokenType } from './primitives/ExprParser';
